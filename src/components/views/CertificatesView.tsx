        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="px-2.5 py-0.5 rounded-full bg-[#141517] text-[#D4A373] text-[11px] font-subheading border border-[#D4A373]/30 flex items-center gap-1">
              ...
              <span>Official Club Accreditation</span>
            </span>
          </div>
          <h1 className="font-heading text-2xl font-bold text-white">Verified Certifications</h1>
          <p className="font-subheading text-xs text-[#8E9296] mt-1">
            Cryptographically signed badges issued for technical breakthroughs, research, and hackathon wins.
          </p>
        </div>
            ...
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="px-2.5 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400 text-[10px] font-subheading border border-emerald-500/20 flex items-center gap-1">
