    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
        <motion.div
          ...
          className="bg-[#0C0D0E] border border-[#26282A] w-full max-w-2xl rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden my-6"
        >
          ...
          {/* Header */}
          <div className="flex items-center justify-between pb-4 border-b border-[#26282A] mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-subheading text-[#8E9296]">
                  Update your intranet profile details, bio, and technical specializations
                </p>
              </div>
            </div>
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs font-subheading">
            ...
            {/* Actions */}
            <div className="flex items-center justify-end gap-3 pt-5 border-t border-[#26282A]">
              <button
                type="button"
                onClick={onClose}
